...
def build_model_config(args: argparse.Namespace, prepared: PreparedDatasetInfo) -> TransformerConfig:
...
def write_run_artifacts(
    ...
    prepared: PreparedDatasetInfo,
    cfg: TransformerConfig,
    export_dir: Path,
) -> dict:
    metrics = {
        "val_token_accuracy": metric_value,
        "val_loss": val_loss,
    }
    ...
    metadata = {
        ...
        "hyperparameters_path": str((run_dir / "hyperparameters.json").as_posix()),
    }
...
def main() -> None:
    ...
    cfg = build_model_config(args, prepared)
